...
(function() {
    PAE.test({
        ...
        'PolyPath bottom mode' : function() {
            ...
            this.assertEquals(poly.getPoint({x: 50, y: 50}),   {x: 50, y: 0},   'Point on straight line works');
            this.assertEquals(poly.getPoint({x: 150, y: 100}), {x: 150, y: 50}, 'Point on diagonal surface works');
